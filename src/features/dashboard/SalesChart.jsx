...
import { eachDayOfInterval, format, isSameDay, subDays } from "date-fns/esm";
...
// Actually we need data in this form... fot the chart
// const fakeData = [
...
function SalesChart({ bookings, numDays }) {
  ...
  return (
    <StyledSalesChart>
      <Heading as="h2">
        Sales from {format(allDates.at(0), "MMM dd yyyy")} &mdash; {format(allDates.at(-1), "MMM dd yyy")}
      </Heading>
